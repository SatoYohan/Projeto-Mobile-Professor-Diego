  ...
  void _popularDadosIniciais() {
    ...
    var tarefasP1 = [
      Tarefa(
        ...
        descricao: '1 cápsula após o almoço',
        concluida: true,
      ),
      Tarefa(
        id: 't2',
        titulo: 'Caminhada leve',
        descricao: '30 minutos, 3 vezes por semana',
      ),
    ];
    var prontuario1 = Prontuario(
      ...
      notasMedico:
          'Paciente apresenta deficiência de vitamina D. Recomendo suplementação e atividade física.',
      tarefas: tarefasP1,
    );
    ...
    var tarefasP2 = [
      Tarefa(
        ...
        descricao: 'Medir diariamente pela manhã',
      ),
    ];
    var prontuario2 = Prontuario(
      ...
      notasMedico:
          'Acompanhar pressão arterial por uma semana. Retornar com anotações.',
      tarefas: tarefasP2,
    );
